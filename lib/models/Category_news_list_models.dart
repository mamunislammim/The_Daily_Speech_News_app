...
class CategoryNewsListModels {
  CategoryNewsListModels({
      bool? success, 
      String? message, 
      Datas? datas,}){
    _success = success;
  ...
  CategoryNewsListModels.fromJson(dynamic json) {
  ...
  String? _message;
  Datas? _datas;
CategoryNewsListModels copyWith({  bool? success,
  String? message,
  Datas? datas,
}) => CategoryNewsListModels(  success: success ?? _success,
